...
io-path depends on Pekko. Akka is now licenced and not open for further development. If you are using Akka you might be able to change the imports and compile a version for Akka. Or you could use an older release [0.9.0](https://github.com/karimagnusson/io-path/releases/tag/0.9.0), that has support for Akka.
